...
![Version: 0.19.20-bb.3](https://img.shields.io/badge/Version-0.19.20--bb.3-informational?style=flat-square) ![AppVersion: 1.8.13](https://img.shields.io/badge/AppVersion-1.8.13-informational?style=flat-square)
...
| istio | object | `{"enabled":true,"mtls":{"mode":"STRICT"}}` | Configuration for Istio interaction |
| istio.enabled | bool | `true` | Toggle currently only controls NetworkPolicies |
